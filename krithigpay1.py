...
krithi=gp.Google_pay("krithi.rajnikanth@gmail.com","7904536978","krithi")
krithi.open_gpay()
krithi.email_verification()
krithi.mobile_verification()
krithi.name_verification()
krithi.otp_verification(15698,15698)
krithi.Bank_verification()
krithi.PanCard_Verification()
krithi.set_Pin("5384")
krithi.Enter_your_Pin(3465,3465)
...
krithi=Phone_pe("krithi708@gmail.com","7904536978","krithi")
krithi.open_phonepe()
krithi.mobile_verification()
krithi.name_verification()
krithi.otp_verification(780965,780965)
krithi.Bank_verification()
krithi.PanCard_Verification()
krithi.set_Pin("238790")
krithi.Enter_your_Pin(3564,3564)
